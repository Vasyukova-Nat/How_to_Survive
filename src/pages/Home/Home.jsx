  ...
  return (
    <div className="home-page">
      ...
      <p style={{ textAlign: "center", fontSize: "20px" }}>
        {" "}
        Много важной информации. Например:{" "}
      </p>
      ...
      <div className="Block1">
        ...
        <div className="right-block1">
          ...
          <p>
            {" "}
            Очень важно сосредоточиться и позвонить <br /> по нужным телефонам{" "}
          </p>
        </div>
      </div>
      ...
      <div className="Block4">
        <div className="left-block4">
          <p>
            {" "}
            В приложении можно <br /> пройти тесты для <br /> закрепления знаний{" "}
          </p>
        </div>
      ...
      <div className="Block5-carousel">
        ...
        <p>
          {" "}
          Приложение имеет следующий функционал. <br />{" "}
        </p>
